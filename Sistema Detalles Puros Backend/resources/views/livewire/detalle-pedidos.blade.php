    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form>
                    <div class="form-group mb-3">
                        ...
                        <select wire:model="id_cliente" id="cliente" class="form-control"
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select wire:model="codigo_puro" wire:change="infoPuro" id="codigo_puro" class="form-control"
                            title="Seleccione un código de puro">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" wire:model="presentacion_puro" id="presentacion_puro" class="form-control"
                            readonly>
                    </div>

                    <div class="form-group mb-3">
                        <label for="marca_puro">Marca del Puro:</label>
                        <input type="text" wire:model="marca_puro" id="marca_puro" class="form-control" readonly>
                    </div>
                    ...
                    <div class="form-group mb-3">
                        <label for="capa_puro">Capa del Puro:</label>
                        <input type="text" wire:model="capa_puro" id="capa_puro" class="form-control" readonly>
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" wire:model="codigo_empaque" id="codigo_empaque" class="form-control">
                    ...
                    <div class="form-group mb-3">
                        ...
                        @if ($imagen_caja && is_object($imagen_caja))
                            <div class="mt-2">
                                <img src="{{ $imagen_caja->temporaryUrl() }}" class="img-thumbnail" width="150">
                            </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="number" wire:model="cantidad_caja" id="cantidad_caja" class="form-control">
                        @error('cantidad_caja')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" wire:click="crearDetallePedidoYEmpaque">
                    Guardar Pedido
                </button>
            </div>
        </div>
