                        ...
                        <tbody class="text-center">
                            @foreach ($datosPaginados as $dato)
                                <tr class="{{ $dato['estado_puro'] == 0 ? 'table-secondary text-muted' : '' }}">
                                    ...
                                    <td>
                                        <span
                                            class="badge {{ $dato['estado_puro'] == 1 ? 'bg-success' : 'bg-danger' }}">
                    ...
                    <div class="modal-body">
                        <form wire:ignore>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" wire:model.lazy="presentacion_puro"
                                    id="register-presentacion_puro" class="form-control"
                                    placeholder="Ingrese la presentación" list="presentacion_puro-list">
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" wire:model.defer="capa" id="register-capa"
                                    class="form-control" placeholder="Ingrese la capa">
