<div>
    ...
    <div class="d-inline-block m-3">
        <div>
            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#registrarusuarioModal">
                Registrar Usuario
            </button>
        </div>
                ...
                <div class="modal-body">
                    <form>
                        <div class="form-group mb-3">
                            ...
                            <input type="text" wire:model="name_usuario" id="update-usuario" class="form-control"
                                placeholder="Ingrese su usuario">
                        </div>
    ...
    <div class="modal fade" id="actualizarContrasenaModal" tabindex="-1" aria-labelledby="updatePasswordModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="updatePasswordModalLabel">Actualizar Contraseña de Usuario</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                </div>
                <div class="modal-body">
                    <form wire:ignore>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="password" wire:model="contrasena_usuario" id="update-contrasena-confirm"
                                class="form-control" placeholder="Confirma la nueva la contraseña">
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
